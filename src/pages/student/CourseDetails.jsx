...
<div className='max-w-xl z-10 text-gray-500'>
  <h1 className='md:text-courese-details-heading-large text-courese-details-heading-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
  <p
...
<div className='flex items-center justify-between px-4 py-3 cursor pointer select-none' onClick={()=>toggleSection(index)}>
  <div className='flex items-center gap-2'>
    <img className={`transfrom transition-transform ${openSections[index]?'rotate-180':''}`} src={assets.down_arrow_icon} alt='arrow-icon'/>
...
<div className='pt-6'>
  <p className='md:text-xl text-lg font-medium text-gray-800'>
    ...
    <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
      ...
      <li>Quizzes to test uour knowledge.</li>
